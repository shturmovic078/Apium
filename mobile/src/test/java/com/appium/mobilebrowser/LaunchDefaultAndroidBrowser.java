...
public class LaunchDefaultAndroidBrowser {
	...
	public void testLaunchBrowser() throws Exception {
		...
		File scrFile1 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
	     ...
	     FileUtils.copyFile(scrFile2, new File("Y://Brands/Charmin" +  "/" + timeStamp + "-LoginError.png"));
	      ...
	      driver.findElement(By.id("phsmartphonebody_0_HlinkEdit")).click();
		    ...
		    File scrFile4 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		     FileUtils.copyFile(scrFile4, new File("Y://Brands/Charmin" +  "/" + timeStamp + "-EditScreen.png"));
		     Thread.sleep(1000);
		     driver.quit();
	}
